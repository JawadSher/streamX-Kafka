...
export const Welcome_To_Unverified_User_Email_Template = ({ firstName }) => {
  return (
    <div
      style={{
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Welcome to the <a href="https://strmx.fun">StreamX</a> Community!
          </p>
        </div>
        ...
        <div style={{ padding: "40px 32px", boxSizing: "border-box" }}>
          ...
          >
            ...
            <strong style={{ color: "#e53e3e" }}>
              To unlock all features of StreamX, please{" "}
              <a
